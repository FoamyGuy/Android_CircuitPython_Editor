...
public class SyncUsbService extends Service {
    ...
    private UsbSerialInterface.UsbReadCallback mCallback = new UsbSerialInterface.UsbReadCallback() {
        ...
        public void onReceivedData(byte[] arg0) {
            Log.i("CircuitPythonEditor", "onreceived data");
            try {
    ...
    public class UsbBinder extends Binder {
        public SyncUsbService getService() {
            return SyncUsbService.this;
        }
    }
        ...
        public void run() {
            while(true){
                ...
                if(n > 0) {
                    ...
                    try {
                        receivedStr = new String(received, "UTF-8");
                    } catch (UnsupportedEncodingException e) {
                        e.printStackTrace();
                    }
